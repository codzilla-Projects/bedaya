    ...
    <footer class="style-2 ">
        <img src="<?=bedaya_URL?>assets/images/bg/footer-vectr1.webp" class="footer-vectr1 img-fluid" alt="image">
        <img src="<?=bedaya_URL?>assets/images/bg/footer-vectr2.webp" class="footer-vectr2 img-fluid" alt="image">
        <div class="footer-top">
            <div class="container">
                <div class="row gy-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <a href="index.html"><img alt="image" src="<?=get_option('bedaya_logo_img');?>">"></a>
                            <p>
                               <?=get_option('footer_content');?>
                            </p>
                            <ul class="footer-social gap-3">
                                <?php $facebook = get_option('bedaya_fb');  
                                    if(!empty($facebook)) :
                                ?>
                                <li><a href="<?=$facebook?>"><i class='bx bxl-facebook'></i></a></li>
                                <?php endif ?>
                                <?php $instagram = get_option('bedaya_insta');  
                                    if(!empty($instagram)) :
                                ?>
                                <li><a href="<?=$instagram?>"><i class='bx bxl-instagram'></i></a></li>
                                <?php endif ?>
                                <?php $youtube = get_option('bedaya_youtube');  
                                    if(!empty($youtube)) :
                                ?>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <ul class="address-list">
                                <?php $location = get_option('bedaya_location');  
                                    if(!empty($location)) :
                                ?>
                                <li class="text-white">
                                    <svg width="28" height="25" viewBox="0 0 14 18" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php endif?>
                                <?php $second_location = get_option('bedaya_second_location');  
                                    if(!empty($second_location)) :
                                ?>
                                <li class="text-white">
                                    <svg width="18" height="25" viewBox="0 0 14 18" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 18C7 18 13.75 11.6033 13.75 6.75C13.75 4.95979 13.0388 3.2429 11.773 1.97703C10.5071 0.711159 8.79021 0 7 0C5.20979 0 3.4929 0.711159 2.22703 1.97703C0.961159 3.2429 0.25 4.95979 0.25 6.75C0.25 11.6033 7 18 7 18ZM7 10.125C6.10489 10.125 5.24645 9.76942 4.61351 9.13649C3.98058 8.50355 3.625 7.64511 3.625 6.75C3.625 5.85489 3.98058 4.99645 4.61351 4.36351C5.24645 3.73058 6.10489 3.375 7 3.375C7.89511 3.375 8.75355 3.73058 9.38649 4.36351C10.0194 4.99645 10.375 5.85489 10.375 6.75C10.375 7.64511 10.0194 8.50355 9.38649 9.13649C8.75355 9.76942 7.89511 10.125 7 10.125Z"/>
                                    </svg>
                                    <span><?=$second_location?></span>
                                </li>
                                <?php endif?>
                                <?php $phone = get_option('bedaya_phone');  
                                    if(!empty($phone)) :
                                ?>
                                <li>
                                ...
                                <?php endif?>
                                <?php $email = get_option('bedaya_email');  
                                    if(!empty($email)) :
                                ?>
                                <li>
                                    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center g-3">
                    <div class="col-lg-6 d-flex justify-content-lg-start justify-content-start">
                        <p>حقوق النشر محفوظة  &copy; <a href="<?php bloginfo('url') ?>" class="egns-lab">مستشفى بداية </a> <?php the_date('Y')?> 
                    </div>
                    <div class="col-lg-6 d-flex justify-content-lg-end justify-content-end">
                        <p>تم التصميم والتطوير بواسطة  <a href="#" class="egns-lab"><img src="<?=bedaya_URL?>assets/images/codezilla-line-white1.webp"></a> 
                    </div>
                </div>
            </div>
        </div>
